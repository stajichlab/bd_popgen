...
godat <- read.table("JEL423.IPR.GO_slim", header=F);
...
summary(OverMF)
OverMF
write.csv(summary(OverMF),"LOH.OverMF_enrich.slim.csv");
...
summary(OverCC)
OverCC
write.csv(summary(OverCC),"LOH.OverCC_enrich.slim.csv");
...
summary(OverBP)
OverBP
write.csv(summary(OverBP),"LOH.OverBP_enrich.slim.csv");
...
summary(Under)
Under
write.csv(summary(Under),"LOH.UnderMF_enrich.slim.csv");
...
summary(UnderCC)
UnderCC
write.csv(summary(UnderCC),"LOH.UnderCC_enrich.slim.csv");
...
summary(UnderBP)
UnderBP
write.csv(summary(UnderBP),"LOH.UnderBP_enrich.slim.csv");
